...
//				else if (message[1] == 1) {
//					// Am besten abwarten bis Server abgearbeitet hat und erst am Ende
...
//				}
			...
			default:
				...
				Connection.errorList.add("Server sent data with unknown OPCODE");
				break;
			}
		}
	}
	...
	private static void read0x01(byte[] message) {
		...
		case 3: // Hex: 0x03
			...
			Connection.errorList.add("Received from Server: train number not in database");
			break;
		case 4: // Hex: 0x04
			// Eingabefehler
		...
		case 7: // Hex: 0x07
			...
			Connection.errorList.add("Received from Server: train data base full");
			break;
		case 8: // Hex: 0x08
			// Steuerkanäle belegt
			Connection.errorList.add("Received from Server: control channel occupied");
			break;
		}
	}
...
//		if (CommunicationUtils.bitIsSet(message[1], 5) && CommunicationUtils.bitIsSet(message[1], 6)) {
...
//		}
	...
	private static void read0x08(byte[] message) {
		...
		case 2: // Hex: 0x02
			...
			// Fahrstufen: 31
			DataToComInterface.addTrain(adrLong, adrShort, opmode, (byte) 0, trainName, (byte) 0,
					(byte) 0, (byte) 0, (byte) 0, 31);
			break;
		case 3: // Hex: 0x03
