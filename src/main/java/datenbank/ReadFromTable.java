...
public class ReadFromTable { 
 ...
 //Gibt die zeit für den Speed durchgang aus
   @SuppressWarnings("null")  
   public String getTempSpeedTime() {
	   String fs = "";
	   Connection conn = null; 
	   Statement stmt = null; 
	      try { 
	         ...
	         System.out.println("Connected database successfully..."); 
	         stmt = conn.createStatement(); 
	         String sql = "SELECT time FROM temp_speed_save"; 
	         ResultSet rs = stmt.executeQuery(sql); 
   ...
   //Gibt die zeit für den Licht durchgang aus
   @SuppressWarnings("null")  
   public String getTempLichtTime() {
	   String fs = "";
	   Connection conn = null; 
	   Statement stmt = null; 
	      try { 
	         ...
	         System.out.println("Connected database successfully..."); 
	         stmt = conn.createStatement(); 
	         String sql = "SELECT time FROM temp_licht_save"; 
	         ResultSet rs = stmt.executeQuery(sql); 
